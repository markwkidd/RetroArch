 ...
 * @param port
 *
 * @return configuration path for the device
 */
 ...
 * @param port
 *
 * @return configuration name for the device
 */
 ...
 * @param port
 *
 * @return true if the device is autoconfigured
 */
 ...
 * 
 * @param port
 * @param id    device type (eg RETRO_DEVICE_JOYPAD, RETRO_DEVICE_LIGHTGUN)
 */
